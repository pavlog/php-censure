<?php
//include(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'CensorWords.php');
/**
		...
		$charset = 'UTF-8')
	{
		...
		if ($re_badwords === null)
		{
			...
			$pretext = array(
				...
				#5
				'[мm]_?[нnh]_?[оo]_?[гg]_?[оo]_?(?![еёe]\s)',    #много
			...
			#Слово на букву #х*й
				...
				#Слово cosi
				'(?<=\PL) [cсs]_?[oaао]_?[cсs]_?[iи]\b', 
				'(?<=\PL) [oо]_?[tт]_?[cсs]_?[oо]_?[cсs]_?[iи]', 
				'(?<=\PL) [cсs]_?[oо]_?[cсs]_?[аa]_?[тt]_?[ь]', 
				#Слово на букву Е
				'(?<=\PL) %RE_PRETEXT%?
                      [eеё]_?
							#исключения
            ...
            ',
				...
				'(?<=\PL) я[еуи][бb][уy] (?=\PL)',  #яебу

				#Слово на букву Е
				'(?<=\PL) ёб (?=\PL)',  #ёб твою мать
				#'(?<=\PL) ёб (?=\PL)',  #ёб твою мать
				#'(?<=\PL) [ё]_?[бb]\b',  #ёб твою мать
				'\b[ёeе]_?[бb]\b',  #ёб твою мать
				'\b[ёeе]_?[бb]_?[tт]\b',  #ёб твою мать
				'[ё]_?[бb] ',  #ёб твою мать
				'([т]_?[в]_?[о]_?[ю]_?[м]_?[а]_?[т]_?[ь])',  #ёб твою мать

				#Слово на букву Е
				'(?<=\PL) ибу (?=\PL)',  #ёб твою мать
				#Слово на букву Б
				'(?<=\PL) %RE_PRETEXT%?
				...
				# c конца слова ПИДОР
				'(?<=\PL) \w*[пp]_?[иieе]_?[дdg]_?[eеaаoо]_?[rpр]\b
				    #исключения:
                      (?<!импидор)  #Импидор
				', 

				#Дебил
				'(?<=\PL) [дв]_?[еэ]_?[бb]_?[иi]_?[лl]\b', 

				#Урод
				'(?<=\PL) [yу][р]_?[оo]_?[д]_?(?![л])', 
				# Уродка
				#'(?<=\PL) [yу]_?[р]_?[оo]_?[д]_?[кk]_?[аa]\b', 
				# Уродец
				#'(?<=\PL) [yу]_?[р]_?[оo]_?[д]_?[eе]_?[ц]\b', 
				# Уроды
				#'(?<=\PL) [yу]_?[р]_?[оo]_?[д]_?[ы]\b', 
				# Гандон				'(?<=\PL) [гg]_?[aoоа]_?[нn]_?[dд]_?[оo]_?[нn]\b', 
				...
				'(?<=\PL) [мm]_?[аa]_?[нnh]_?[дdg]_?[aаyуыiеeoо]_  #манд[ауыео]
                      #исключения:
                      (?<! манда(?=[лн]|рин)
                         | manda(?=[ln]|rin)
                      )
